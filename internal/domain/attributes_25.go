...
func (a AttributeSet25) Has1() bool {
	return strings.TrimSpace(a.Field1) != ""
}

func (a AttributeSet25) Has2() bool {
	return strings.TrimSpace(a.Field2) != ""
}

func (a AttributeSet25) Has3() bool {
	return strings.TrimSpace(a.Field3) != ""
}

func (a AttributeSet25) Has4() bool {
	return strings.TrimSpace(a.Field4) != ""
}

func (a AttributeSet25) Has5() bool {
	return strings.TrimSpace(a.Field5) != ""
}

func (a AttributeSet25) Has6() bool {
	return strings.TrimSpace(a.Field6) != ""
}

func (a AttributeSet25) Has7() bool {
	return strings.TrimSpace(a.Field7) != ""
}

func (a AttributeSet25) Has8() bool {
	return strings.TrimSpace(a.Field8) != ""
}

func (a AttributeSet25) Complete() bool {
